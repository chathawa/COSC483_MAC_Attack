...
class SHA1:
    ...
    default_h = [0x67452301, 0xEFCDAB89, 0x98BADCFE, 0x10325476, 0xC3D2E1F0]

    def __init__(self, msg: bytes, iv: Tuple[int, int, int, int, int] = None):
        """:param ByteString msg: The message to be hashed."""
        if msg is None:
            msg = b""

        self.msg = msg
        self.h = self.default_h if iv is None else iv
